...
*/
    ...
    DECLARE @CatEmployee   UNIQUEIDENTIFIER,
            ...
            @IdEmpresa     VARCHAR(20) = 'EMP014' -- NUEVA VARIABLE DEFINIDA AQUÍ
    ...
    BEGIN EXEC dbo.AC_pro_General_GenerateBulkInt @tabla = 'RolesActors', @IdEmpresa = @IdEmpresa, @IdUnico = @Id OUTPUT;
