...
1			Edwin Casa  			10-03-2023		39191		Codigo Inicial - Procedimiento para abastraer informacion de picking para el scanner segundo nivel - timeout 90s
...
*/
ALTER     PROCEDURE [dbo].[pro_GetOutboundOrderPickingByCarrier]
(
	@idBodega VARCHAR(16),
